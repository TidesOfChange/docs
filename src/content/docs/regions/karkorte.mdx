...
## Species
<CardGrid>
    <LinkCard title="Mutated Humans" href="../species/mutated-humans" description="Mutated Humans are a species of humans from Karkorte." />
</CardGrid>

## Classes from Karkorte
<CardGrid>
    <LinkCard title="Scavenger" href="../class/scavenger" description="Scavengers maintain the city and are considered the backbone of society." />
    <LinkCard title="Hunter" href="../class/hunter" description="Hunters are essential to the city as they are the main source of food and weapons." />
</CardGrid>

## Campaigns from Karkorte
<CardGrid>
    <LinkCard title="Trouble in Karkorte" href="../campaigns/trouble-in-karkorte" description="Food and morale are low in Karkorte and you have to show if you have what it takes to survive." />
</CardGrid>
