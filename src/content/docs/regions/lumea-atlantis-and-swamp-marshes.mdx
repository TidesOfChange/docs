...
{/* prettier-ignore */}
<p style="text-align: center;">Map of Lumea, Atlantis, Sludge Swamps, and Lux Reservoir</p>

## Atlantis: The Human City

<p align="center">![Map Atlantis](../../../assets/lumea/atlantis.png)</p>

<p style="text-align: center;">_A look inside Atlantis City_</p>
...
<CardGrid>
    <LinkCard
        ...
        href="/docs/campaigns/save-aqualumean-child"
        description="One of the corrupted Aqualumeans who has been exposed to the pollution of the Sludge Swamps."
    />
    <LinkCard
        title="Save Astralyss, the kidnapped Celestial Dragon"
        href="/docs/campaigns/save-astralyss"
        description="A Celestial Dragon named Astralyss has been kidnapped by the evil scientists and hidden deep within their laboratory."
    />
    <LinkCard
        title="Scientists Divided in Atlantis"
        href="/docs/campaigns/scientists-divided-in-atlantis"
        description="Two groups of scientists within Atlantis who are developing different solutions for pollution."
    />
</CardGrid>
