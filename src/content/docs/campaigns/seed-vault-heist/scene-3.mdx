...
The players can try to disable the card reader since the only access into the seed vault is through the garage door which requires a keycard for access. 

If players are successful in breaking into the vault on their own, they gain 5-10 XP.
...
**Skills:**
- Reaction +8
- Force +2 (Can scale up for higher level players)
- Awareness +8
- Medicine +6
- Charm +1
