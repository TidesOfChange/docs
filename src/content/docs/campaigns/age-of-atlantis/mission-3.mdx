...
description: Mission 3 of the Age of Atlantis campaign
...
## Mission 3.1: Finding a cause to join amongst the scientists of Atlantis.
...
**Stats**  
- Cybernetics (knowledge): +5  
- Mechanics (knowledge): +5  
- Strength: -1
- HP: +5  
- Deduction (knowledge): +4  
...
## Mission 3.2: The conflict at the reservoir.
:::note[Location]
The Reservoir
:::
