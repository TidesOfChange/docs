...
## <span className="heading-shipwreck">The Shipwreck</span>
...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
  ...
  <div>
    <p>Any protesting from the party is ignored, he continues what he’s doing without any acknowledgement. If they try to physically interrupt him he will protest saying “IF you continue to prevent my work it will only take longer until I am able to help you. Sit. Down.”</p>
