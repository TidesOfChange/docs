...
Cloudrunners need to be able to adapt and survive in a chaos-fueled environment on a daily basis. Because of their lifestyles, Cloudrunners have become prevalent in skills of **Mechanics, Vehicles, Thievery, Sneakiness & Force**. They also pose a unique skill to only their culture: Flying (Agility). Cloudrunners’ ability to fly through use of their equipment allows for members to be able to navigate through the airways, by means of both transportation and conflict. The typical Cloudrunner has been seen to hold an array of wooden weapons (each doing 2 harm), a cloudrunning kite for matters of flight, and a forging kit that aids in their prevalent needs of creating false IDs and other critical documents. Cloudrunners also have the ability to communicate with cohorts who may not seem so friendly. As with their nature, Cloudrunners have been seen dealing with leaders of regional cells, corporation contacts, and other bosses from their previous work.

## Expertise Tree

![Image of Cloudrunners Expertise Tree](../../../assets/archipelago/cloudrunner-et-archipelago.png)
...
| Informant Network: You have connections that run deep in criminal networks. When seeking information, you are able to find someone who can either tell you or find out for you - for the right price, of course  | Mask of Many: Your time as a Cloudrunner has taught you the value of having multiple identities. Your disguises are good enough to pass cursory inspection and you can always obtain realistic fake ID documents for a new persona | Unwavering Resolve: You never back down from a fight, and you only grow more determined when the odds are stacked against you. When you are in melee range of more than one enemy, add +1 per enemy to reaction, bypass that many harm from ranged attacks, and you may distribute harm from attacks among multiple enemies of your choice |
| Featherstep: Your training and experience lets you gracefully adapt to unexpected circumstances. You take no harm from falling 30ft or less and may turn any effect that would knock you prone into an elegant somersault. | Reflexive Evasion: Your instincts alert you to incoming attacks early, giving you extra precious moments to dodge. Once per round you can roll your reaction to dodge an attack. | Cloudburst: You channel the essence of clouds inside your soul, expelling steam in a powerful burst around you as an action. Everyone in melee range is pushed back 10 feet and takes 1 harm, bypassing armor. |